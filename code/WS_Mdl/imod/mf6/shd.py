...
from WS_Mdl.core.style import Sep, blue, sprint


def from_HD_Out(MdlN: str, date_B_YMD: str, MdlN_B: bool | str = True, fill_NA: bool = True):
    """
    Creates SHD files from HD Out of B Simulation. Add 1 day to the HD Out date, as SHDs are for the beginning of the next SP (assumes daily time-step).
    ...
    - fill_NA: Whether to fill NA values in the SHD files (uses linear interpolation, then fills with closest neighbor where linear didn't work.).
    """
