...
MdlN_HD_OBS     =   'NBr77'
Pa_HD_OBS_In    =   M.Pa.In / f'OBS/HD/{MdlN_HD_OBS}/GWHD_{MdlN_HD_OBS}.OBS6'
Pa_HD_OBS_Out   =   M.Pa.Sim_In / f'{M.MdlN}_GWHD.OBS6'
...
rule copy_HD_OBS:
    ...
    output:
        Pa_HD_OBS_Out
    run:
        sh.copy2(Pa_HD_OBS_In, output[0]) # Copy the file to the Sim_In folder.
        from WS_Mdl.imod.mf6.nam import add_Pkg
        add_Pkg(M.MdlN, fr'  OBS6 ./imported_model/{M.MdlN}_GWHD.OBS6')  # Add to NAM
